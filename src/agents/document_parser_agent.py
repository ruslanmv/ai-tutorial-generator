    ...
    def run(self, doc: Document) -> List[Document]:
        ...
        Returns:
            List[Document]: One per parsed block, with `page_content` set
                            to the extracted text, image path, or table markdown,
                            and metadata including original_source, docling_type,
                            and any refs.
        """
        ...
        # Write content to a temp file for Docling
        ...
        try:
            ...
            for item in getattr(docling_doc, "iter_items", lambda: [])():
                ...
                # Attach any reference if available
